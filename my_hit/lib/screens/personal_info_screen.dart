        ...
        child: Stack(
          children: <Widget>[
            ...
            Container(
              ...
              height:deviceSize.orientation ==Orientation.portrait? deviceSize.size.height * 0.6: null,
              ...
              child:Container(
                ...
                child: Icon(Icons.perm_identity,size: 70,color: Colors.white,),
                  radius: 50.0,
                ),
                SizedBox(width: deviceSize.size.width * 0.03,),
                Column(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: <Widget>[
                    Text('Melisa Melisa', style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold,color: Colors.white,),),
                     SizedBox(height: deviceSize.size.height * 0.02,),
                    Text('melisa@gmail.com',style:TextStyle(fontSize: 18,color: Colors.white),),
                      SizedBox(height: deviceSize.size.height * 0.02,),
                    Text('0734354619',style:TextStyle(fontSize: 18,color: Colors.white),),
