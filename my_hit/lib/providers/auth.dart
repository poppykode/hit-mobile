...
class Auth with ChangeNotifier {
  ...
  Future<void> signin(File image, String username, String firstName,
      String lastname, String email, String courseId, String password) async {
    ...
    try {
      ...
      final _image =
          http.MultipartFile('image', stream, length, filename: _filename);
      ...
      print('pano mu provider ma1');
      print(error + ' ' + 'pano mu provider ma1');
      throw (error);
    }
  }
